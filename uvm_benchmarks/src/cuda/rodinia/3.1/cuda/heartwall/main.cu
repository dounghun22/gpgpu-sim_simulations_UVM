...
int main(int argc, char *argv []){
  ...
  printf("WG size of kernel = %d \n", NUMBER_THREADS);
	...
	cudaMallocManaged((void **)&common.d_endoRow, common.endo_mem);
	memcpy(common.d_endoRow, common.endoRow, common.endo_mem);
	...
	cudaMallocManaged((void **)&common.d_endoCol, common.endo_mem);
	memcpy(common.d_endoCol, common.endoCol, common.endo_mem);

	common.tEndoRowLoc = (int *)malloc(common.endo_mem * common.no_frames);
	cudaMallocManaged((void **)&common.d_tEndoRowLoc, common.endo_mem * common.no_frames);

	common.tEndoColLoc = (int *)malloc(common.endo_mem * common.no_frames);
	cudaMallocManaged((void **)&common.d_tEndoColLoc, common.endo_mem * common.no_frames);
	...
	cudaMallocManaged((void **)&common.d_epiRow, common.epi_mem);
	memcpy(common.d_epiRow, common.epiRow, common.epi_mem);
	...
	cudaMallocManaged((void **)&common.d_epiCol, common.epi_mem);
	memcpy(common.d_epiCol, common.epiCol, common.epi_mem);

	common.tEpiRowLoc = (int *)malloc(common.epi_mem * common.no_frames);
	cudaMallocManaged((void **)&common.d_tEpiRowLoc, common.epi_mem * common.no_frames);

	common.tEpiColLoc = (int *)malloc(common.epi_mem * common.no_frames);
	cudaMallocManaged((void **)&common.d_tEpiColLoc, common.epi_mem * common.no_frames);
	...
	for(common_change.frame_no=0; common_change.frame_no<frames_processed; common_change.frame_no++){
		...
		memcpy(common_change.d_frame, frame, common.frame_mem);
	...
	memcpy(common.tEndoRowLoc, common.d_tEndoRowLoc, common.endo_mem * common.no_frames);
	memcpy(common.tEndoColLoc, common.d_tEndoColLoc, common.endo_mem * common.no_frames);

	memcpy(common.tEpiRowLoc, common.d_tEpiRowLoc, common.epi_mem * common.no_frames);
	memcpy(common.tEpiColLoc, common.d_tEpiColLoc, common.epi_mem * common.no_frames);
